            ...
            <!-- 고정바(순위,상품명,가격,마일리지,배송) 라벨-->
               <table style="width:100%">
                ...
                <c:forEach items = "${yogaRanking}" var= "yoga" varStatus="status">
                 ...
                 <input type="hidden" id="pName" name="pName" value="${yoga.getpName() }">
                		<table style="width:100%">
                   			<tr style="height:100px;">
                     			...
                     			<th style="width:150px; height:43px;"><center><input type="image" src="resources/assets/img${yoga.getpImg() }" style="width:120px; height: 100px;" alt=""  ></center>
                     			<th style="width:200px; height:43px;"><center><h4>${yoga.getpName() }</h4></center>
                     			<th style="width:150px; height:43px;"><center><h4><fmt:formatNumber pattern="###,###,###" value="${yoga.getpPrice()}" />원</h4></center>

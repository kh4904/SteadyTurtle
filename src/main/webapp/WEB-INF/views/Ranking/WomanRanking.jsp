...
<body id="page-top">
	...
	<section class="page-section portfolio">
		<div class="container">
			...
			<!-- 상품 랭킹 1~5위 -->
                <!-- 상품랭킹1위-->
                <c:forEach items = "${womanRanking}" var= "woman" varStatus="status">
                 <c:if test = "${status.count eq '1'}">
                 <form action="product" method="POST">
                 <input type="hidden" id="pName" name="pName" value="${woman.getpName() }">
                		<table style="width:100%">
                   			<tr style="height:100px;">
                     			...
                     			<th style="width:150px; height:43px;"><center><input type="image" src="${woman.getpUrl() }" style="width:120px; height: 100px;" alt=""  ></center>

			...
			<div class="col-lg-12">
				<form action="main" method="post" id="regForm">
					...
					<div class="list-group"
						...
						<p>
							<input type="text" name="muserAddr1" id="mAddr2_address" placeholder="주소">
							<input type="text" name="muserAddr2" id="mAddr2_detailAddress" placeholder="상세주소">
							<input type="text" name="muserAddr3" id="mAddr2_extraAddress" placeholder="참고항목">
						</p>

		...
		<div class="divider-custom" style="display: block;">
			...
			<div class="orderInfo">
					...
					<div class="inputArea">
						...
						<c:if test="${member.getmGender() eq '남성'}">
							<input type="hidden" value="1" id="pMan" name="pMan">
							<input type="hidden" value="0" id="pWoman" name="pWoman">
						</c:if>
						<c:if test="${member.getmGender() eq '여성'}">
							<input type="hidden" value="0" id="pMan" name="pMan">
							<input type="hidden" value="1" id="pWoman" name="pWoman">
						</c:if>
					</div>
								...
								$(".order_btn").click(function(){
									...
									if(confirm_val) {
										...
										$.ajax({
											url:"/ex/basket",
											type : "post",
											data : {chbox : checkArr, chbox2 : checkArr2, jMile : $('#jMile').val(),
												...
												pMan : $('#pMan').val() ,pWoman : $('#pWoman').val() },

				...
				<div class="jumbotron"
							...
							<div class="tab-pane fade show active" id="login">
								...
								<form method="post" action="LoginSuccess">
									...
									<div class="form-group" style="position: relative; top: 1px;">
										I D : <input type="text" class="form-control"
											placeholder="아이디" id="mId" name="mId" maxlength="20"
								...
								<form method="post" action="loginAction.jsp">
									...
									<div class="form-group" style="position: relative; top: 1px;">
										이름 <input type="text" class="form-control"
											placeholder="입력해주세요" name="userName" maxlength="20"
											style="width: 200px; height: 40px; position: relative; left: 40px; top: -30px;">
									</div>
									<!-- 전화번호 입력 -->
									<div class="form-group" style="position: relative; top: -30px;">
					...
					<c:if test="${member != null }">
						...
						<ul class="nav nav-pills"
							...
							<li role="presentation" class="active">
								<p>
									사용기능/누적 <br /> 마일리지<br /> <label>${member.mMile }/${member.mCumulmile} p</label>
								</p>
							</li>
						...
						<ul class="nav nav-pills"
							...
							<form method="post" action="logout">
								<input type="submit" class="btn btn-link" id="logoutbtn" value="로그아웃" style="font-size:15px; color: black; text-decoration: none;">
							</form>
							</li>
						</ul>
					</c:if>
